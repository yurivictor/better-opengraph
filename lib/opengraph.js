  ...
  get: function ( url, options, callback ) {
    ...
    request( this.options, function( error, response, body ) {
      if ( ! error && response.statusCode == 200 ) {
        ...
        meta['image'] = {};
        meta['image']['url'] = $( 'meta[property="og:image"]' ).attr( 'content' ) || $( 'link[rel="image_src"]' ).attr( 'href' ) || null;
...
og.get( 'https://www.nytimes.com/2015/11/25/us/chicago-officer-charged-in-death-of-black-teenager-official-says.html', function ( response ) {
